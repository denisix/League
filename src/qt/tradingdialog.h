...
private slots:
    ...
    QString BuyLGA(QString OrderType, double Quantity, double Rate);
    QString SellLGA(QString OrderType, double Quantity, double Rate);
